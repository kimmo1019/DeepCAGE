...
def model_evaluation(model,region_idx,padding=400):
    for cellid in test_cell_idx:
        ...
        f_out = open('%s/CNN/outcome/final/DenseAttNet_seq_gexp_motif_bootstrap_reg_fold%d.log'%(DPATH,fold_idx),'a+')
        f_out.write('%d\t%.5f\n'%(cellid,corr))
        f_out.close()
...
if  __name__ == "__main__" :
    ...
    model.save('%s/CNN/models/final/DenseAttNet_seq_gexp_motif_reg_fold%d.h5'%(DPATH,fold_idx))
